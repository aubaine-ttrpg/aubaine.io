 ...
 */
final class Version20260123103619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE simple_skills ADD COLUMN ultimate BOOLEAN NOT NULL');
        $this->addSql('ALTER TABLE simple_skills ADD COLUMN category VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE simple_skills ADD COLUMN ability VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE simple_skills ADD COLUMN aptitude VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE simple_skills ADD COLUMN limitations CLOB DEFAULT NULL');
