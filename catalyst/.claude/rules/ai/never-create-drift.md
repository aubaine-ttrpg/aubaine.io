...
scripts, workflows, or another document's list in a second place. If you are tempted to mirror a real
set, name the source instead of its members.
...
**Enforced by:** review; the `athletis-ai-tell-remover` skill.
