...
description: Reliability, scalability, replication, partitioning, transactions, and data streams.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books designing-data-intensive-applications.mini.md. -->
