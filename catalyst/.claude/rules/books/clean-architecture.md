...
description: Organize systems around stable boundaries and the dependency rule, keeping business policy independent of detail.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books clean-architecture.mini.md. -->
