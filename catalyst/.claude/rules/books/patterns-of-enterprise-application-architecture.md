...
description: Enterprise patterns for layering, domain logic, data access, and object-relational mapping.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books patterns-of-enterprise-application-architecture.mini.md. -->
