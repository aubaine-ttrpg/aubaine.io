...
**Good / Bad:**
```
Bad:  the aubaine-commit skill restates the Gitmoji table and branch rules in full.
Good: the skill is thin and says "follow CONTRIBUTING.md" with a link; the rules live there once.

Bad:  rules/README.md lists every file in the folder; a new file is added and the list is forgotten.
