...
an imagined reader who shared your conversation. This is context dumping, and a classic AI tell.
...
**Enforced by:** review, specifically the meta/self-consistency review lens; plus the aubaine-content-writer skill on prose. (Not script-checkable: a regex cannot judge meaning, so this is enforced by reading, not grep.)
