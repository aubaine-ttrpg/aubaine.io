...
description: Fight complexity with deep modules, simple interfaces, and information hiding.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books a-philosophy-of-software-design.mini.md. -->
