...
description: Pragmatic craft built on DRY, orthogonality, automation, and responsible, adaptive development.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books the-pragmatic-programmer.mini.md. -->
