...
description: A concise tour of DDD covering subdomains, bounded contexts, context maps, and core tactical patterns.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books domain-driven-design-distilled.mini.md. -->
