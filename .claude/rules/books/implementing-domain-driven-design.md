...
description: DDD in practice covering aggregates, domain events, bounded-context integration, and application services.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books implementing-domain-driven-design.mini.md. -->
