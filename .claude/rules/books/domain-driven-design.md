...
description: Model the domain with a ubiquitous language, bounded contexts, and tactical and strategic patterns.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books domain-driven-design.mini.md. -->
