---
name: release-it
description: Production-ready systems through stability patterns, timeouts, circuit breakers, and operability.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books release-it.mini.md. -->
