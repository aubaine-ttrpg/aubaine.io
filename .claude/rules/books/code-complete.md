---
name: code-complete
description: Software construction craft covering routine and class design, variables, control flow, and defensive programming.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books code-complete.mini.md. -->
