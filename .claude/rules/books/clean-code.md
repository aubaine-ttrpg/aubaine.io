---
name: clean-code
description: Readability above cleverness, with clear naming, small single-purpose functions, and tests treated as production code.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books clean-code.mini.md. -->
