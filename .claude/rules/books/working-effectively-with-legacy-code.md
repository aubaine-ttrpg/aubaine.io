...
description: Change untested code safely using seams and characterization tests.
severity: prefer
---
<!-- Source: ciembor/agent-rules-books working-effectively-with-legacy-code.mini.md. -->
