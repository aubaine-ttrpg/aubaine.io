...
**Why:** AI-generated patches often make tools pass by weakening the tools instead of fixing the code. The repository's quality bar is the thing protecting it; quietly lowering it to admit generated code defeats the entire static-analysis and test investment.

**Good / Bad:**
```php
// Bad: widen the type and suppress to make PHPStan green.
/** @param mixed $page */
public function render($page): void {} // @phpstan-ignore-line
