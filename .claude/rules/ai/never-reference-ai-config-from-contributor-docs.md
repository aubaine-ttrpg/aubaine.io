...
**Good / Bad:**
```
Bad:  README links `.claude/rules/`; CONTRIBUTING says "see the aubaine-commit skill".
Good: CONTRIBUTING stands alone; the aubaine-commit skill reads CONTRIBUTING.md and says
