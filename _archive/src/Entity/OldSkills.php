...
#[ORM\Entity(repositoryClass: OldSkillsRepository::class)]
#[ORM\Table(name: 'old_skills')]
#[ORM\HasLifecycleCallbacks]
#[Gedmo\TranslationEntity(class: OldSkillsTranslation::class)]
class OldSkills
{
    #[ORM\Id]
    ...
    #[ORM\JoinTable(
        name: 'old_skills_tags',
        joinColumns: [new ORM\JoinColumn(name: 'skills_id', referencedColumnName: 'id')],
